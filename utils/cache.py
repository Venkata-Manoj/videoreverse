...
def hash_video_file(video_path, byte_limit=64 * 1024):
...
def get_cache_key(video_path, options=None):
    if options is None:
        options = {}
...
def get_cache_info(video_path, options=None):
    if options is None:
        options = {}
    ensure_cache_dir()
...
def get_cached(key, cache_type='blueprint'):
    ensure_cache_dir()
...
def get_cached_by_path(video_path, options=None):
    if options is None:
        options = {}
    ensure_cache_dir()
...
def set_cache(video_path, data, options=None):
    if options is None:
        options = {}
    ensure_cache_dir()
    key = get_cache_key(video_path, options)
